...
// 
// It uses BoneJ for conncted components analysis; thereofore
// the "BoneJ experimental" update site needs to be activated.
//
...
cca_time = getTime();
run("Particle Analyser", "exclude min=10.000 max=Infinity surface_resampling=2 show_particle surface=Gradient split=0.000 volume_resampling=2 labelling=Mapped slices=2");
IJ.log("BJ CCA took" + (getTime() - cca_time));
